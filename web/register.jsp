...
<script>
    $(function () {
        ...
        <div class="content">
            <div class="login_wrapper" style="background-image:url('image/fore/register.jpg'); background-repeat: no-repeat; margin-top: 10px">
                <div class="glass" style="height: 430px"></div>
